        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Discover our premium collection of curtains, bedding, towels, and home decor.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm">
                Premium home decor and furnishings for the modern lifestyle.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/products" className="hover:text-white transition-colors">Decor</Link></li>
              </ul>
            </div>
            <div>
